...
namespace SUIFW
{
    ...
    internal static class SysDefine
    {
        ...
        public const string SYS_PATH_CNLauguageJson = "Config/LauguageJSONConfig";
        public const string SYS_PATH_SysConfigJson = "Config/SysConfigInfo";
        public const string SYS_PATH_UIFormConfigJson = "Config/UIFormsConfigInfo";
